...
public class PeliculaControlador {
    ...
    public ResponseEntity<Map<String, Object>> update(@PathVariable Integer id,
        ...
        try {
            ...
            if (peliculaDb != null) {
                responseAsMap.put("pelicula", pelicula);
                responseAsMap.put("mensaje", "Pelicula modificada correctamente, id " + pelicula.getId());
                responseEntity = new ResponseEntity<Map<String, Object>>(responseAsMap, HttpStatus.OK);
            } else {
            ...
            responseAsMap.put("mensaje", "Pelicula no ha sido creada, problema "+e.getMostSpecificCause().toString());
            responseEntity = new ResponseEntity<Map<String, Object>>(responseAsMap, HttpStatus.INTERNAL_SERVER_ERROR);
